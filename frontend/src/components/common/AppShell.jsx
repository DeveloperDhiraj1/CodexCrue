...
const iconPaths = {
  ...
  settings: <><path d="M12 3.5 13.2 5a7.3 7.3 0 0 1 1.8.7l1.9-.5 1.7 1.7-.5 1.9c.3.6.6 1.2.7 1.8l1.5 1.2v2.4l-1.5 1.2a7.3 7.3 0 0 1-.7 1.8l.5 1.9-1.7 1.7-1.9-.5a7.3 7.3 0 0 1-1.8.7L12 21h-2.4l-1.2-1.5a7.3 7.3 0 0 1-1.8-.7l-1.9.5L3 17.6l.5-1.9a7.3 7.3 0 0 1-.7-1.8L1.3 12.7v-2.4l1.5-1.2c.1-.6.4-1.2.7-1.8L3 5.4l1.7-1.7 1.9.5c.6-.3 1.2-.6 1.8-.7L9.6 2h2.4z" /><circle cx="10.8" cy="11.5" r="2.7" /></>,
