...
const paths = {
  ...
  paths: <><circle cx="5" cy="18" r="2" /><circle cx="12" cy="7" r="2" /><circle cx="19" cy="17" r="2" /><path d="m6.7 16.8 3.7-7.6m3.4-.2 3.5 6.3" /></>,
  learning: <><path d="M12 3 3 7.5 12 12l9-4.5zM6 10v5c3 2.5 9 2.5 12 0v-5" /></>,
...
export default function Icon({ name, size = 21 }) { return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">{paths[name] || paths.learning}</svg>; }
