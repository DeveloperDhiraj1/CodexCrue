...
router.post('/register', authLimiter, verifyFirebaseToken({ requireVerified: false, requireApplicationUser: false }), authController.register);
router.post('/sync', authLimiter, verifyFirebaseToken({ requireVerified: false, requireApplicationUser: false }), authController.sync);
